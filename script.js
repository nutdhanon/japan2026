...
const DAY_VISUALS = {
  ...
  "day-2": {
    icon: "⛩",
    image: "https://wallpapercat.com/w/full/e/b/4/687774-3840x2160-desktop-4k-osaka-castle-wallpaper.jpg",
  },
  "day-3": {
    icon: "⛩",
  ...
  "day-5": {
    icon: "⚽",
    image: "https://chorareii.com/wp-content/uploads/2021/05/chorareii_towerofthesun_osaka_tarookamoto_front-768x1024.jpeg",
  },
  "day-6": {
    icon: "👜",
  ...
  "day-7": {
    icon: "⚓",
    image: "https://cms.talonjapan.com/wp-content/uploads/2024/06/kobe-port-tower-2.webp",
  },
  "day-8": {
    icon: "☁",
    image: "https://www.aerotime.aero/images/EVA-Air-Boeing-787-9-landing-at-Soekarno%E2%80%93Hatta-International-Airport-CGK.jpg",
  },
};
...
const I18N = {
  th: {
    ...
    "hero.kicker": "คู่มือทริปส่วนตัว",
    "hero.title": "Osaka Slow Life 2026",
    "hero.summary": "ใช้ชีวิตช้าๆ ในโอซาก้า 9 วัน 8 คืน",
    ...
    "overview.day2.title": "แลนด์มาร์กคลาสสิกของโอซากะ",
    "overview.day2.body": "Castle Park → Yasaka → Shinsekai → Dotonbori",
    "overview.day3.label": "วันที่ 3",
    "overview.day3.title": "Kyoto Heritage",
    "overview.day3.body": "Toji → Toji Udon → Fushimi Inari → Kiyomizu → Gion",
  ...
  en: {
    ...
    "hero.kicker": "Personal trip guide",
    "hero.title": "Osaka Slow Life 2026",
    "hero.summary": "Living slowly in Osaka for 9 days and 8 nights.",
    "hero.tones.kyoto": "Osaka days and nights",
    "hero.tones.namba": "Kyoto heritage",
    "hero.tones.kobe": "Kobe slow day",
    ...
    "overview.day2.title": "Classic Local Osaka",
    "overview.day2.body": "Castle Park → Yasaka → Shinsekai → Dotonbori",
  ...
  ja: {
    ...
    "hero.kicker": "個人用トラベルガイド",
    "hero.title": "Osaka Slow Life 2026",
    "hero.summary": "大阪でゆっくり過ごす、9日間・8泊の旅。",
    ...
    "overview.day2.title": "大阪クラシックローカル",
    "overview.day2.body": "大阪城公園 → 難波八阪 → 新世界 → 道頓堀",
    "overview.day3.label": "3日目",
    "overview.day3.title": "京都ヘリテージ",
    "overview.day3.body": "東寺 → 東寺うどん → 伏見稲荷 → 清水寺 → 祇園",
    "overview.day4.label": "Day 4",
  ...
  zh: {
    ...
    "overview.day2.title": "大阪经典本地日",
    "overview.day2.body": "大阪城公园 → 难波八阪 → 新世界 → 道顿堀",
    "overview.day3.label": "第3天",
    "overview.day3.title": "京都文化日",
    "overview.day3.body": "东寺 → Toji Udon → 伏见稻荷 → 清水寺 → 祇园",
...
const PROTOTYPE_DAYS = [
  ...
  },
  {
    ...
    title: "Classic Local Osaka",
    route: "VIA INN → Osaka Castle Park → Morinomiya → Namba Yasaka → Shinsekai → Dotonbori",
    hotel: "VIA INN PRIME Shinsaibashi Yotsubashi",
    summary: "Classic Local Osaka Day ที่เริ่มจากแลนด์มาร์กหลักของเมือง ต่อด้วย Namba Yasaka ก่อนเวลาปิด แล้วค่อยไหลไป Shinsekai และ Dotonbori ตอนกลางคืน",
    ...
    events: [
      ...
      },
      {
        ...
        place: "Transit",
        blurb: "จาก Morinomiya ใช้ Osaka Metro ไป Namba area แล้วเดินต่อไป Namba Yasaka Jinja",
        blurbI18n: {
          en: "From Morinomiya, take Osaka Metro to the Namba area, then walk to Namba Yasaka Jinja.",
          ja: "森ノ宮から大阪メトロでなんば方面へ移動し、難波八阪神社まで歩きます。",
          zh: "从森之宫搭乘大阪地铁到难波区域，再步行前往难波八阪神社。",
        },
      ...
      },
      {
        ...
        place: "Namba Yasaka Jinja",
        blurb: "ถ่ายรูปหัวสิงโต เดินศาลเจ้า และพักขาสั้น ๆ",
        blurbI18n: {
          en: "Take photos of the lion head stage, walk around the shrine, and take a short rest.",
          ja: "獅子殿を撮影し、境内を少し歩いて休憩。",
          zh: "拍摄狮子头舞台，逛神社并短暂休息。",
        },
        map: "https://maps.google.com/?q=Namba+Yasaka+Jinja",
        note: {
          th: {
            title: "บ่ายยังแสงสวย",
            body: "ช่วงบ่ายแสงยังสวยและไม่เสี่ยงเรื่องเวลาปิด",
            list: ["ถ่ายรูปไวและพักขาสั้น ๆ", "เลี่ยงความเสี่ยงปิดประมาณ 17:00"],
          },
        },
      },
      {
        ...
        blurbI18n: {
          en: "From Namba, move toward Dobutsuen-mae / Ebisucho, then walk Shinsekai, Tsutenkaku, retro streets, light snacks, and early evening neon photos.",
          ja: "なんばから動物園前 / 恵美須町方面へ移動し、新世界、通天閣、レトロな通り、軽いスナック、夕方のネオンを楽しみます。",
          zh: "从难波前往 Dobutsuen-mae / Ebisucho，逛新世界、通天阁、复古街道，吃点小食并拍傍晚霓虹。",
        },
        map: "https://maps.google.com/?q=Shinsekai+Tsutenkaku+Osaka",
        note: {
          th: {
            title: "retro Osaka ช่วงไฟเริ่มเปิด",
            body: "Shinsekai ช่วงเย็น vibe ดีกว่าตอนบ่าย เพราะไฟเริ่มเปิดและ retro Osaka ชัดขึ้น",
            list: ["แสงดีขึ้นช่วงเย็น", "ค่อยไหลต่อ Dotonbori ได้สวย"],
          },
        },
      },
      {
        ...
        titleI18n: {
          en: "Dotonbori / Hozenji / Namba Night",
          ja: "道頓堀 / 法善寺 / なんばナイト",
          zh: "道顿堀 / 法善寺 / 难波夜晚",
        },
        place: "Night",
        blurb: "เดิน Glico, Hozenji Yokocho, dinner, bar หรือ cafe ตาม mood หน้างาน",
        blurbI18n: {
          en: "Walk around Glico, Hozenji Yokocho, dinner, and optional bar or cafe depending on the mood.",
          ja: "グリコ、法善寺横丁、夕食、気分に合わせてバーやカフェへ。",
          zh: "逛 Glico、法善寺横丁，晚餐后可按心情去酒吧或咖啡店。",
        },
  ...
  },
  {
    ...
    route: "Osaka → Kyoto Station → Toji → Toji Udon → Fushimi Inari → Kiyomizu → Gion",
    hotel: "VIA INN PRIME Shinsaibashi Yotsubashi",
    ...
    events: [
      {
        ...
        title: "Osaka → Kyoto Station → Toji → Toji Udon",
        place: "Kyoto Morning",
        blurb: "เริ่มด้วย JR Special Rapid ไป Kyoto Station ต่อ Toji แล้วกิน Toji Udon brunch ก่อนช่วงเดินหลัก",
        map: "https://maps.google.com/?q=Kyoto+Station",
        note: { th: { title: "morning flow", body: "Toji ก่อน Toji Udon ทำให้เช้าเกียวโตเดินง่ายและไม่เร่งเกินไป", list: ["ICOCA ใช้ได้", "Toji Udon อยู่ใกล้ Toji"] } },
      },
      {
        id: "d3-inari",
        time: "12:15–15:00",
...
function applyApprovedDayDetails() {
  ...
  Object.assign(byId["day-2"], {
    title: "แลนด์มาร์กคลาสสิกของโอซากะ",
    titleI18n: {
      th: "แลนด์มาร์กคลาสสิกของโอซากะ",
      en: "Classic Local Osaka",
      ja: "大阪クラシックローカル",
      zh: "大阪经典本地日",
    },
    route: "VIA INN → Morinomiya → Osaka Castle Park → Namba Yasaka Jinja → Shinsekai → Dotonbori",
    routeI18n: {
      th: "VIA INN → Morinomiya → Osaka Castle Park → Namba Yasaka Jinja → Shinsekai → Dotonbori",
      en: "VIA INN → Morinomiya → Osaka Castle Park → Namba Yasaka Jinja → Shinsekai → Dotonbori",
      ja: "VIA INN → 森ノ宮 → 大阪城公園 → 難波八阪神社 → 新世界 → 道頓堀",
      zh: "VIA INN → 森之宫 → 大阪城公园 → 难波八阪神社 → 新世界 → 道顿堀",
    },
    summary: "วันโอซากะแบบ classic local เริ่มจากปราสาทและมื้อกลางวันแถว Morinomiya ต่อด้วย Namba Yasaka Jinja ก่อนปิดเวลา แล้วค่อยไหลไป Shinsekai และ Dotonbori night",
    summaryI18n: {
      th: "วันโอซากะแบบ classic local เริ่มจากปราสาทและมื้อกลางวันแถว Morinomiya ต่อด้วย Namba Yasaka Jinja ก่อนปิดเวลา แล้วค่อยไหลไป Shinsekai และ Dotonbori night",
      en: "A classic local Osaka day: start with Osaka Castle and lunch around Morinomiya, visit Namba Yasaka Jinja before closing time, then flow into Shinsekai and Dotonbori night.",
      ja: "大阪城と森ノ宮ランチから始め、閉門前に難波八阪神社へ。その後は新世界、道頓堀の夜へ流れるクラシックな大阪ローカルデー。",
      zh: "经典大阪本地日：从大阪城与森之宫午餐开始，先在关门前去难波八阪神社，再接新世界与道顿堀夜晚。",
    },
    events: [
  ...
  Object.assign(byId["day-3"], {
    ...
    route: "Osaka → Kyoto Station → Toji → Toji Udon → Fushimi Inari → Taxi to Kiyomizu → Higashiyama → Hanamikoji → Gion Duck Rice → Kamogawa → Kyoto-kawaramachi → Osaka",
    routeI18n: {
      th: "Osaka → Kyoto Station → Toji → Toji Udon → Fushimi Inari → Taxi to Kiyomizu → Higashiyama → Hanamikoji → Gion Duck Rice → Kamogawa → Kyoto-kawaramachi → Osaka",
      en: "Osaka → Kyoto Station → Toji → Toji Udon → Fushimi Inari → Taxi to Kiyomizu → Higashiyama → Hanamikoji → Gion Duck Rice → Kamogawa → Kyoto-kawaramachi → Osaka",
      ja: "大阪 → 京都駅 → 東寺 → 東寺うどん → 伏見稲荷 → タクシーで清水寺方面 → 東山 → 花見小路 → Gion Duck Rice → 鴨川 → 京都河原町 → 大阪",
      zh: "大阪 → 京都站 → 东寺 → Toji Udon → 伏见稻荷 → Taxi 到清水寺 → 东山 → 花见小路 → Gion Duck Rice → 鸭川 → Kyoto-kawaramachi → 大阪",
    },
    summary: "Toji ตอนเช้า, Toji Udon brunch, Fushimi Inari ถึง Yotsutsuji แล้วปิดวันด้วย Kiyomizu, Higashiyama, Gion และ Kamogawa",
    summaryI18n: {
      th: "Toji ตอนเช้า, Toji Udon brunch, Fushimi Inari ถึง Yotsutsuji แล้วปิดวันด้วย Kiyomizu, Higashiyama, Gion และ Kamogawa",
      en: "Morning Toji, Toji Udon brunch, Fushimi Inari up to Yotsutsuji, then Kiyomizu, Higashiyama, Gion, and Kamogawa in the evening.",
      ja: "朝の東寺、東寺うどんブランチ、四ツ辻までの伏見稲荷。その後は清水寺、東山、祇園、鴨川へ。",
      zh: "早上东寺、Toji Udon brunch、伏见稻荷到四辻，之后接清水寺、东山、祇园和鸭川夜散步。",
    },
    previewNow: "2026-05-19T16:30:00+09:00",
    events: [
      ...
      makeStep("d3-toji-udon", "11:00–12:00", "11:00", "12:00", "Brunch — Toji Udon", "Toji Udon", "เดินจาก Toji Temple ไปร้าน Toji Udon ประมาณ 2–3 นาที กิน brunch แบบ local Kyoto style ก่อนเริ่ม afternoon walking flow", "https://maps.google.com/?q=Toji+Udon+Kyoto", "local Kyoto brunch", "เมนูแนะนำคือ udon น้ำร้อน, tempura udon, curry udon หรือ rice set เบา ๆ จุดนี้ดีเพราะอยู่ใกล้ Toji มาก ไม่ต้อง detour และเบากว่าราเมงก่อนเดิน Fushimi Inari", ["ไม่ควรกินหนักเกิน เช่น set ใหญ่มาก ของทอดเยอะ หรือเบียร์กลางวัน เพราะหลังจากนี้ยังมี Fushimi Inari walking route ประมาณ 2 ชั่วโมง"], { titleI18n: { en: "Brunch — Toji Udon", ja: "ブランチ — 東寺うどん", zh: "早午餐 — Toji Udon" }, blurbI18n: { en: "Walk about 2–3 minutes from Toji Temple to Toji Udon for a local Kyoto-style brunch before the afternoon walking flow.", ja: "東寺から徒歩約2〜3分の東寺うどんへ。午後の散策前に、京都らしいローカルなうどんブランチ。", zh: "从东寺步行约 2–3 分钟到 Toji Udon，在下午步行行程前吃一顿京都本地风格早午餐。" }, note: { th: { title: "local Kyoto brunch", body: "เมนูแนะนำคือ udon น้ำร้อน, tempura udon, curry udon หรือ rice set เบา ๆ จุดนี้ดีเพราะอยู่ใกล้ Toji มาก ไม่ต้อง detour และเบากว่าราเมงก่อนเดิน Fushimi Inari", list: ["ไม่ควรกินหนักเกิน เช่น set ใหญ่มาก ของทอดเยอะ หรือเบียร์กลางวัน เพราะหลังจากนี้ยังมี Fushimi Inari walking route ประมาณ 2 ชั่วโมง"] }, en: { title: "Local Kyoto brunch", body: "Recommended options: hot udon, tempura udon, curry udon, or a light rice set. This works well because it is very close to Toji, requires no detour, and feels lighter than ramen before walking Fushimi Inari.", list: ["Avoid eating too heavily, such as a large set, too much fried food, or daytime beer, because the Fushimi Inari walking route still takes around 2 hours afterward."] }, ja: { title: "京都らしいローカルブランチ", body: "おすすめは温かいうどん、天ぷらうどん、カレーうどん、または軽めのご飯セット。東寺から近く、寄り道が少なく、伏見稲荷を歩く前にラーメンより軽めです。", list: ["この後に伏見稲荷の散策が約2時間あるため、大きすぎるセット、揚げ物多め、昼ビールは控えめに。"] }, zh: { title: "京都本地 brunch", body: "推荐热乌冬、天妇罗乌冬、咖喱乌冬，或简单米饭套餐。这里离东寺很近，不需要绕路，而且在走伏见稻荷前比拉面更轻盈。", list: ["后面还有约 2 小时的伏见稻荷步行路线，不建议吃太重，例如大套餐、太多炸物或白天喝啤酒。"] } } }),
      makeStep("d3-fushimi", "12:15–14:30", "12:15", "14:30", "Fushimi Inari — Tower Gate → Senbon Torii → Yotsutsuji", "Fushimi Inari Shrine Tower Gate", "จาก Toji Udon เดินไป Toji Station → Kintetsu Kyoto Line ไป Kyoto → transfer ไป JR Nara Line → ลง Inari Station จากนั้นเดิน route: Fushimi Inari Shrine Tower Gate → Senbon Torii → Yotsutsuji Intersection → turn back down", "https://maps.google.com/?q=Fushimi+Inari+Shrine+Tower+Gate", "Yotsutsuji แล้วกลับ", "รวมค่าเดินทางประมาณ ¥330 ไม่ต้องขึ้น summit เพราะ highlight หลักอยู่ก่อนยอด หลัง Yotsutsuji เส้นทางเริ่ม repetitive และ fatigue เพิ่มมากกว่า reward", ["Fushimi Inari Shrine Tower Gate", "Senbon Torii", "Yotsutsuji Intersection", "Turn back down"], { titleI18n: { en: "Fushimi Inari — Tower Gate → Senbon Torii → Yotsutsuji", ja: "伏見稲荷 — 楼門 → 千本鳥居 → 四ツ辻", zh: "伏见稻荷 — 楼门 → 千本鸟居 → 四辻" }, blurbI18n: { en: "From Toji Udon, walk to Toji Station, take the Kintetsu Kyoto Line to Kyoto, transfer to the JR Nara Line, and get off at Inari Station. Walk the route: Fushimi Inari Shrine Tower Gate → Senbon Torii → Yotsutsuji Intersection → turn back down.", ja: "東寺うどんから東寺駅へ歩き、近鉄京都線で京都へ。JR奈良線に乗り換えて稲荷駅で下車。伏見稲荷大社 楼門 → 千本鳥居 → 四ツ辻 → 下山の流れで歩きます。", zh: "从 Toji Udon 步行到 Toji Station，搭乘 Kintetsu Kyoto Line 到 Kyoto，转 JR Nara Line 到 Inari Station。步行路线：伏见稻荷大社楼门 → 千本鸟居 → 四辻 → 原路下山。" }, note: { th: { title: "Yotsutsuji แล้วกลับ", body: "รวมค่าเดินทางประมาณ ¥330 ไม่ต้องขึ้น summit เพราะ highlight หลักอยู่ก่อนยอด หลัง Yotsutsuji เส้นทางเริ่ม repetitive และ fatigue เพิ่มมากกว่า reward", list: ["Fushimi Inari Shrine Tower Gate", "Senbon Torii", "Yotsutsuji Intersection", "Turn back down"] }, en: { title: "Turn back at Yotsutsuji", body: "Transport is around ¥330. No need to summit: the main highlights come before the peak, and after Yotsutsuji the route becomes more repetitive while fatigue rises more than the reward.", list: ["Fushimi Inari Shrine Tower Gate", "Senbon Torii", "Yotsutsuji Intersection", "Turn back down"] }, ja: { title: "四ツ辻で折り返し", body: "移動費は約¥330。山頂まで行く必要はありません。見どころは手前に集中しており、四ツ辻以降は変化が少なく、疲労のわりに満足度が増えにくいです。", list: ["伏見稲荷大社 楼門", "千本鳥居", "四ツ辻", "下山"] }, zh: { title: "四辻折返", body: "交通约 ¥330。不需要登顶；主要亮点在山顶前，四辻之后路线较重复，疲劳增加但回报感不明显。", list: ["伏见稻荷大社楼门", "千本鸟居", "四辻", "原路下山"] } } }),
